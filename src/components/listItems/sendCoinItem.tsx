...
const SendCoinItem: React.FC<sendCoinItemProps> = (props) => {
    ...
    return (
        ...
        >
            ...
            <View>
                {!hidePrice && <BodyText style={styles.priceTxt}>{Number(item.amount || 0)?.toFixed(4)} {item.symbol}</BodyText>}
            </View>
        </TouchableOpacity>
    )
}
